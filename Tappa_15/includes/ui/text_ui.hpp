...
private:
    sf::Vector2i getColor(TextColor color);
...
public:
    ...
    void drawString(std::string str, float x, float y, sf::RenderWindow &window, TextColor color = WHITE);
    void drawString(std::string str, float x, float y, sf::RenderWindow &window, float scaleFactor);
    void drawString(std::string str, float x, float y, sf::RenderWindow &window, float scaleFactor, TextColor color = WHITE);
};